...
void DrawPolygon(cv::Mat img, int points[][2], int poly_corners, int outline_color, int fill_color);
void DrawUnion(cv::Mat img, int polygon1[][2], int poly_corners1, int polygon2[][2], int poly_corners2, int outline_color, int fill_color);
void DrawIntersection(cv::Mat img, int polygon1[][2], int poly_corners1, int polygon2[][2], int poly_corners2, int outline_color1, int fill_color1, int outline_color2, int fill_color2);
